...
├── encryption/ pipeline/ secrets/                       Future (v0.8.x security & utility primitives)
...
| **0.8.x** | **Foundation + security/utility primitives — Laravel-parity reshuffle** | **0.8.0: `config` (env/file/static/remote)** · **0.8.1: `events` (sync + async wrapper, wildcards)** · **0.8.2: `hashing` (bcrypt/argon2id/scrypt + `NeedsRehash`)** · 0.8.3: `encryption` (aesgcm/chacha20poly1305) · 0.8.4: `pipeline` · 0.8.5: `secrets` (env/file/vault/gcpsm/awssm) |
